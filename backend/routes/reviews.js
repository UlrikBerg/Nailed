...
// GET /reviews/mine — the caller's own reviews, newest first. Hidden reviews
// (admin-removed or author-deleted) are excluded so the user's profile reflects
// what's actually live on the salon page. MUST be declared before any `/:id`
// route so Express doesn't capture "mine" as an id.
